    ...
    <?php $this->load->view('header/header-2.php') ?>
      ...
      <div class="page-header">
        ...
        <div style="text-align: center;">
          <img src="https://media.giphy.com/media/46zriYYzSq7KCG82vF/giphy.gif" width="100" style="display: inline-block;">
        <img src="https://i.giphy.com/media/8L0Pb4b92CFOhougNu/giphy.webp" width="100" style="display: inline-block;">
