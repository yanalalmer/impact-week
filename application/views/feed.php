...
<div class="wrapper">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            <button type="button" id="sidebarCollapse" class="btn " style=" background-color:#22626B; color:white; margin-left: -32px; margin-top:-6px;">
        ...
        */
        ...
        ?>
          ...
          <div  class=" card col-sm-6 offset-sm-2 p-2 mb-1 bg-light text-dark border-dark">
            ...
            <h5 class="card-title p-2 text-white" style="background-color: #22626B">
